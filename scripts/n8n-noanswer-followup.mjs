...
const fSms = {
  parameters: {
    ...
    jsonBody: `={\n  "from": "+16896002720",\n  "to": ["${ph}"],\n  "content": "Hi ${fn}, this is Toro Movers — we just tried to reach you about your move. When's a good time to call? Or get your up-front quote: https://toromovers.com/quote . Reply STOP to opt out."\n}`,
    options: {},
  },
