...
const FAQS = [
  ...
  },
  {
    ...
    a: `Book one to two weeks ahead when you can, especially for weekends, month-end, gated community windows, and larger multi-bedroom homes. Same-week scheduling is often available — call ${PHONE_DISPLAY} or request an estimate online and we’ll tell you what’s open.`,
  },
  {
