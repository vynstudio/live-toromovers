...
const FAQS = [
  ...
  },
  {
    ...
    a: `Book one to two weeks ahead when you can, especially for weekends, month-end dates, and gated communities that need advance gate clearance. Same-week scheduling is often available — call ${PHONE_DISPLAY} or request an estimate online and we’ll tell you what’s open.`,
  },
  {
