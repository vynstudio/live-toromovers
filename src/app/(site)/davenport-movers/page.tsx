...
const FAQS = [
  ...
  },
  {
    ...
    a: `Book one to two weeks ahead when you can, especially for weekends, builder possession days, HOA gate windows, and end-of-month rental turnovers. Same-week scheduling is often available — call ${PHONE_DISPLAY} or request an estimate online and we’ll tell you what’s open.`,
  },
  {
