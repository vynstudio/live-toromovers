...
const FAQS = [
  ...
  },
  {
    ...
    a: `Book one to two weeks ahead when you can, especially for weekends, school-calendar moves, month-end lease turnovers, and UCF-area move-in windows. Same-week scheduling is often available — call ${PHONE_DISPLAY} or request an estimate online and we’ll tell you what’s open.`,
  },
  {
